...
public class ProcessResults {
	public static Triple<int[], int[], int[]> readResults(
			HashMap<String, Match> matchMap, ArrayList<Student> studentList, ArrayList<Alumni> alumniList, 
			ValueAndReason[][][] matchReasons, double[][] matchScores, int numReasonsToPrint, int numPriorities) throws FileNotFoundException{
	...
	public static void outputMatchScores(ArrayList<Alumni> alumniList, ArrayList<Student> studentList, double[][] matchScores) throws FileNotFoundException {
		PrintWriter output = null;
		try {
